      ...
      <main className="main">
        <section className="pageBanner" id="banner_section">
          ...
          <div className="itsTimeto">
            <h1 class="title text-center fontStyle">IT’S TIME TO MONETIZE </h1>
        ...
        <section id="machineLearning" className="SameSection streamersWaiting">
              ...
              <div className="col-lg-6">
                <div className="thumbContent text-left">
                  <div className="headingSection brandTitle  gradientBorder">
                    ...
                    <h1 className="title">
                      The platform <br /> streamers have <br /> been waiting for
                    </h1>
                  </div>
        ...
        <section className="gridImages page-section" id="gridImagesWithNumbers">
          <div className="container">
            <div className="row">
              <div className="col-xl-12 col-lg-12 col-md-12">
                <h1 class="title text-center mainHeadingLine"> How It Works</h1>
              </div>
            </div>
            <div className="row">
            ...
            <div className="row">
              <div className="col-xl-8 col-lg-8 col-md-12">
                <div className="audienceContainer commonAttrofGrid">
                  ...
                  <p>
                    {" "}
                    Have a small audience? We understand nano streamers are much
                    more engaged with their audiences, creating loyalty and
                    trust. In marketing jargon, this is “leveraging authentic
                    engagement” – but real-talk: it simply means brands
                    recognize that your audience respects your opinion, and if
                    you like their products they’ll pay you to tell the world.
                  </p>
                </div>
              </div>
